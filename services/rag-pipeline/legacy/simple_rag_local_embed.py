...
# --- NEW: Import from Hugging Face transformers ---
import torch
...
# --- 5. Define the RAG Chain (Using Local Hugging Face) ---

print("Loading local HF model (distilgpt2)...")

# --- REPLACED OLLAMA WITH HUGGING FACE PIPELINE ---
model_id = "Qwen/Qwen3-4B-Instruct-2507" # A small, fast model for testing
...
hf_pipe = pipeline(
    ...
    model=model, 
    tokenizer=tokenizer, 
    max_new_tokens=200  # Control the length of the answer
)

# Wrap the transformers pipeline in a LangChain LLM object
...
Question: {question}
Answer:""" # Note: The prompt is simpler for non-chat models
...
print("\n--- Asking RAG question (with local HF) ---")
